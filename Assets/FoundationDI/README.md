...
- **오브젝트 풀 / 사운드** — 키 기반 GameObject 풀링, SFX/BGM 재생과 볼륨 영속화
...
| **SoundService** | SFX/BGM 재생과 `PlayerPrefs` 볼륨 영속화. R3 `Observable.EveryUpdate`로 프레임당 중복 SFX 재생을 방지. | — |
